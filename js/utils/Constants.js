...
const CONSTANTS = {
  ...
  // ===== PROLOGUE STORY =====
  PROLOGUE_LINES: [
    "Jo and his father ran the legendary paresan in Caloocan",
    "Famous for sabaw that could cure heartbreak",
    "But a jealous inspector and a clout-chasing vlogger ",
    "Filmed a fake video claiming the secret ingredient was 'magic'.",
    "The viral video caused an outcry,that the government shut them down.",
    "Jo's father hung up his apron, truly heartbroken.",
    "But Jo couldn't let go of the dream. He grabbed his heavy-duty ladle.",
    "And he swore to cook his way back to the top!",
  ],
